...
!(function (t, e) {
  ...
  return (function () {
    ...
    function c(t) {
      ...
      return n(i ? l(t.value, s) : t.value);
    }
    function h(t, e) {
      const i = t.x - e.x,
        s = t.y - e.y;
    ...
    function m(t, e, i, s, o, n) {
      ...
      return (
        e.min >= s.min &&
          ...
          e.max >= s.min &&
          e.max <= s.max &&
          ((t.max >= i.min && t.max <= (i.max + i.min) / 2 && o > 0) ||
            (t.min <= i.max && t.min > (i.max + i.min) / 2 && o < 0)) &&
          ((a.velocity = o * -n), (a.bounced = !0)),
        a
      );
    }
    function y(t, e) {
    ...
    function z(t, e, i = !0) {
      return t[void 0 !== e && i ? e % t.length : M(t)];
    }
    function P(t, e, i, s) {
      return C(T(t, null != i ? i : 0), e, s);
    }
    function C(t, e, i) {
      let s = !0;
      return (
        (i && "bottom" !== i) || (s = t.top < e.height),
        !s || (i && "left" !== i) || (s = t.right > 0),
        !s || (i && "right" !== i) || (s = t.left < e.width),
        !s || (i && "top" !== i) || (s = t.bottom > 0),
        s
      );
    }
    function T(t, e) {
      ...
      for (const i of e) {
        ...
        for (const e in i) {
          ...
          const s = i[e],
            o = "object" == typeof s,
            n = t;
          n[e] = o && Array.isArray(s) ? s.map((t) => S(n[e], t)) : S(n[e], s);
        }
      }
      return t;
    }
    ...
    function I(t, e, i) {
      if (e instanceof Array)
        for (const s of e) {
          const e = s.mode;
          s.enable && x(t, e) && E(s, i);
        }
      else {
        const s = e.mode;
        e.enable && x(t, s) && E(e, i);
      }
    }
    function E(t, e) {
      const i = t.selectors;
      if (i instanceof Array) for (const s of i) e(s, t);
      else e(i, t);
    }
    function R(t, e) {
      if (e && t)
        return t instanceof Array
          ? t.find((t) => y(e, t.selectors))
          : y(e, t.selectors)
          ? t
          : void 0;
    }
    ...
    function D(t, e) {
      ...
      if (i * a + s * r >= 0) {
        const i = -Math.atan2(r, a),
          ...
          d = c.rotate(-i),
          u = h.rotate(-i);
        (t.velocity.x = d.x * t.factor.x),
          (t.velocity.y = d.y * t.factor.y),
    ...
    function W(t) {
      var e;
      return null === (e = q(t)) || void 0 === e ? void 0 : e.a;
    }
    function B(t) {
      return q(t);
    }
    ...
    function K(t) {
      const e = null != t ? t : 0;
      return {
        b: Math.floor(o(l(e, 256))),
        g: Math.floor(o(l(e, 256))),
        r: Math.floor(o(l(e, 256))),
      };
    }
    function tt(t, e) {
    ...
    function st(t, e, i, o) {
      ...
      return (
        void 0 === n.r && (n = j(t)),
        void 0 === a.r && (a = j(e)),
        { b: s(n.b, a.b, i, o), g: s(n.g, a.g, i, o), r: s(n.r, a.r, i, o) }
      );
    }
    function ot(t, e, i) {
      var s, o;
      ...
      {
        const i =
            null !== (s = t.getFillColor()) && void 0 !== s
              ? s
              : t.getStrokeColor(),
          n =
            null !== (o = null == e ? void 0 : e.getFillColor()) && void 0 !== o
              ? o
              : null == e
              ? void 0
              : e.getStrokeColor();
        if (i && n && e) return st(i, n, t.getRadius(), e.getRadius());
        {
          const t = null != i ? i : n;
          if (t) return j(t);
        }
    ...
    function rt(t, e, i) {
      ...
      return e && (lt(s.h, e.h, i), lt(s.s, e.s, i), lt(s.l, e.l, i)), s;
    }
    function lt(t, e, i) {
    ...
    function ut(t, e, i, s, o, n, a, r, l, c, u, v) {
      let p = !1;
      if (d(i, s) <= o) ct(t, i, s), (p = !0);
      else if (a) {
        let e, a;
        const r = h(i, { x: s.x - n.width, y: s.y });
        if (r.distance <= o) {
          const t = i.y - (r.dy / r.dx) * i.x;
          (e = { x: 0, y: t }), (a = { x: n.width, y: t });
        } else {
          const t = h(i, { x: s.x, y: s.y - n.height });
          if (t.distance <= o) {
            const s = -(i.y - (t.dy / t.dx) * i.x) / (t.dy / t.dx);
            (e = { x: s, y: 0 }), (a = { x: s, y: n.height });
          } else {
            const t = h(i, { x: s.x - n.width, y: s.y - n.height });
            if (t.distance <= o) {
              const s = i.y - (t.dy / t.dx) * i.x;
              (e = { x: -s / (t.dy / t.dx), y: s }),
                (a = { x: e.x + n.width, y: e.y + n.height });
            }
          }
        }
        e && a && (ct(t, i, e), ct(t, s, a), (p = !0));
      }
      if (p) {
        if (
          ((t.lineWidth = e),
    ...
    function vt(t, e, i, s, o, n, a, r) {
      !(function (t, e, i, s) {
        ...
        o && (t.globalCompositeOperation = n),
        (t.fillStyle = tt(a, r)),
        t.fill();
    }
    ...
    function ft(t, e, i, s) {
      ...
      const r = e.getPosition(),
        l = i.getPosition(),
        c = st(n, a, e.getRadius(), i.getRadius()),
        h = t.createLinearGradient(r.x, r.y, l.x, l.y);
      return (
        h.addColorStop(0, et(n, s)),
        h.addColorStop(o > 1 ? 1 : o, tt(c, s)),
        h.addColorStop(1, et(a, s)),
        h
      );
    }
    function mt(t, e, i, s, o, n) {
      t.save(),
        ct(t, i, s),
        (t.strokeStyle = tt(o, n)),
        (t.lineWidth = e),
        t.stroke(),
        t.restore();
    }
    function yt(t, e, i, s, o, n, a, r, l, c, h, d) {
      var u, v, p, f, m, y;
      const g = i.getPosition(),
        w = i.options.tilt,
        b = i.options.roll;
      if ((e.save(), w.enable || b.enable)) {
        const t = b.enable && i.roll,
          s = w.enable && i.tilt,
          o = t && ("horizontal" === b.mode || "both" === b.mode),
          n = t && ("vertical" === b.mode || "both" === b.mode);
        e.setTransform(
          o ? Math.cos(i.roll.angle) : 1,
          s ? Math.cos(i.tilt.value) * i.tilt.cosDirection : 0,
          s ? Math.sin(i.tilt.value) * i.tilt.sinDirection : 0,
      ...
      if (
        ...
        e.fillStyle = i;
      } else o && (e.fillStyle = o);
      const M = i.stroke;
      (e.lineWidth = null !== (m = i.strokeWidth) && void 0 !== m ? m : 0),
        n && (e.strokeStyle = n),
        gt(t, e, i, l, c, s),
        (null !== (y = null == M ? void 0 : M.width) && void 0 !== y ? y : 0) >
          0 && e.stroke(),
        i.close && e.closePath(),
        i.fill && e.fill(),
        e.restore(),
    ...
    function xt(t, e, i, s) {
      void 0 !== e.drawParticle &&
        (t.save(), e.drawParticle(t, i, s), t.restore());
    }
    function kt(t, e, i, s, o, n, a, r, l) {
      const c = e.getPosition();
      if ((i && (t.strokeStyle = et(i, o)), 0 === n)) return;
      t.lineWidth = n;
      const h = (a * Math.PI) / 180;
      t.beginPath(), t.ellipse(c.x, c.y, s / 2, 2 * s, h, r, l), t.stroke();
    }
    function Mt(t, e, i) {
      ...
      intersects(t) {
        ...
        if (void 0 !== e.size) {
          const t = e.size,
            ...
            r = t.height;
          return (
            a.x < n.x + s && a.x + i > n.x && a.y < n.y + o && a.y + r > n.y
          );
        }
        return !1;
      }
    ...
    class Tt extends Pt {
      constructor(t, e, i, s) {
        super(t, e, i),
          (this.canvasSize = s),
          (this.canvasSize = { height: s.height, width: s.width });
      }
      contains(t) {
        ...
        const s = { x: t.x, y: t.y - this.canvasSize.height };
      ...
      intersects(t) {
        ...
        if (void 0 !== i.radius) {
          const t = new Pt(s.x, s.y, 2 * i.radius);
          return super.intersects(t);
        }
        if (void 0 !== e.size) {
          const t = new Ct(s.x, s.y, 2 * e.size.width, 2 * e.size.height);
          return super.intersects(t);
        }
        return !1;
      }
    ...
    class It {
      ...
      handleClickMode(t) {
        ...
        switch (t) {
          case "push":
            if (s > 0) {
              const t = z([void 0, ...i.interactivity.modes.push.groups]),
                o = void 0 !== t ? e.actualOptions.particles.groups[t] : void 0;
              e.particles.push(s, e.interactivity.mouse, o, t);
            }
            break;
          case "remove":
      ...
      async nextFrame(t) {
        ...
        try {
          ...
          const s = t - i.lastFrameTime,
            o = { value: s, factor: (60 * s) / 1e3 };
          if (((i.lifeTime += o.value), (i.lastFrameTime = t), s > 1e3))
            return void i.draw(!1);
          if (
    ...
    class Lt {
      ...
      init() {
        const t = Ft(this, At, "f").plugins.getInteractors(this.container, !0);
    ...
    class Ht {
      ...
      moveParticle(t, e) {
        ...
        const u = this.container,
          ...
          p =
            (null !== (i = (a = t.retina).moveSpeed) && void 0 !== i
              ? i
              : (a.moveSpeed = n(d.speed) * u.retina.pixelRatio)) *
            u.retina.reduceFactor,
          f =
            null !== (s = (l = t.retina).moveDrift) && void 0 !== s
              ? s
              : (l.moveDrift = n(t.options.move.drift) * u.retina.pixelRatio),
          m = r(c.size.value) * u.retina.pixelRatio,
          y =
            p * (((d.size ? t.getRadius() / m : 1) * v * (e.factor || 1)) / 2);
        this.applyPath(t, e);
        const g = d.gravity,
          w = g.enable && g.inverse ? -1 : 1;
        g.enable &&
          y &&
          (t.velocity.y += (w * (g.acceleration * e.factor)) / (60 * y)),
          f && y && (t.velocity.x += (f * e.factor) / (60 * y));
        const b = t.moveDecay;
        ...
        g.enable &&
          g.maxSpeed > 0 &&
          ((!g.inverse && x.y >= 0 && x.y >= k) ||
            (g.inverse && x.y <= 0 && x.y <= -k)) &&
          ((x.y = w * k), y && (t.velocity.y = x.y / y));
        const M = t.options.zIndex,
          z = (1 - t.zIndexFactor) ** M.velocityRate;
        d.spin.enable
          ? this.spin(t, y)
          : (1 != z && x.multTo(z),
            t.position.addTo(x),
      ...
      moveParallax(t) {
        const e = this.container,
          i = e.actualOptions;
        if (g() || !i.interactivity.events.onHover.parallax.enable) return;
        const s = i.interactivity.events.onHover.parallax.force,
    ...
    class jt {
      ...
      subdivide() {
        const t = this.rectangle.position.x,
          ...
          o = this.capacity;
        (this.northEast = new jt(new Ct(t, e, i / 2, s / 2), o)),
          (this.northWest = new jt(new Ct(t + i / 2, e, i / 2, s / 2), o)),
          (this.southEast = new jt(new Ct(t, e + s / 2, i / 2, s / 2), o)),
          (this.southWest = new jt(
            new Ct(t + i / 2, e + s / 2, i / 2, s / 2),
            o
          )),
          (this.divided = !0);
      }
              ...
              null !==
                (n =
                  ...
                  (null === (i = this.northWest) || void 0 === i
                    ? void 0
                    : i.insert(t)) ||
                  (null === (s = this.southEast) || void 0 === s
                    ? void 0
                    : s.insert(t)) ||
      ...
      queryCircle(t, e) {
        return this.query(new Pt(t.x, t.y, e));
      }
      queryCircleWarp(t, e, i) {
        const s = i,
          o = i;
        return this.query(
          new Tt(t.x, t.y, e, void 0 !== s.canvas ? s.canvas.size : o)
        );
      }
      queryRectangle(t, e) {
        return this.query(new Ct(t.x, t.y, e.width, e.height));
      }
      query(t, e) {
        var i, s, o, n;
        const a = null != e ? e : [];
        ...
        for (const e of this.points)
          (!t.contains(e.position) &&
            d(t.position, e.position) > e.particle.getRadius()) ||
            a.push(e.particle);
        return (
          this.divided &&
            (null === (i = this.northEast) || void 0 === i || i.query(t, a),
            null === (s = this.northWest) || void 0 === s || s.query(t, a),
            null === (o = this.southEast) || void 0 === o || o.query(t, a),
    ...
    class Gt {
      ...
      static clone(t) {
        return Gt.create(t.x, t.y);
      }
      static create(t, e) {
        return new Gt(t, e);
      }
      static get origin() {
        return Gt.create(0, 0);
      }
      get angle() {
      ...
      add(t) {
        return Gt.create(this.x + t.x, this.y + t.y);
      }
      addTo(t) {
      ...
      mult(t) {
        return Gt.create(this.x * t, this.y * t);
      }
      multTo(t) {
        (this.x *= t), (this.y *= t);
      }
    ...
    class $t extends Gt {
      ...
      add(t) {
        return t instanceof $t
          ? $t.create(this.x + t.x, this.y + t.y, this.z + t.z)
          : super.add(t);
      }
      addTo(t) {
        super.addTo(t), t instanceof $t && (this.z += t.z);
      }
      sub(t) {
        return t instanceof $t
          ? $t.create(this.x - t.x, this.y - t.y, this.z - t.z)
      ...
      subFrom(t) {
        super.subFrom(t), t instanceof $t && (this.z -= t.z);
      }
      mult(t) {
        return $t.create(this.x * t, this.y * t, this.z * t);
      }
      multTo(t) {
      ...
      setTo(t) {
        super.setTo(t), t instanceof $t && (this.z = t.z);
      }
    }
    class Jt {
      constructor(t) {
      ...
      resize() {
        ...
        (i.width = this.element.offsetWidth * e),
          ...
          this.container.started &&
            (this.resizeFactor = { width: i.width / s, height: i.height / o });
      }
      drawConnectLine(t, e) {
        this.draw((i) => {
          var s;
          ...
          pt(
            i,
            null !== (s = t.retina.linksWidth) && void 0 !== s
              ? s
      ...
      drawParticle(t, e) {
        ...
        if (!l && !c) return;
        let [h, d] = this.getPluginParticleColors(t);
        const u = t.options.twinkle.particles,
          v = u.enable && Math.random() < u.frequency;
        if (!h || !d) {
          const t = V(u.color);
          h || (h = v && void 0 !== t ? t : l || void 0),
            d || (d = v && void 0 !== t ? t : c || void 0);
        }
        const p = this.container.actualOptions,
          f = t.options.zIndex,
          m = (1 - t.zIndexFactor) ** f.opacityRate,
          y = t.getRadius(),
          g = v
            ? u.opacity
            : null !==
        ...
        (x || d) &&
          this.draw((i) => {
            const s = (1 - t.zIndexFactor) ** f.sizeRate,
              o = d ? et(d, w * m) : x;
            if (y <= 0) return;
      ...
      initTrail() {
        const t = this.container.actualOptions,
          e = H(t.particles.move.trail.fillColor);
        if (e) {
      ...
      getPluginParticleColors(t) {
        ...
        for (const [, s] of this.container.plugins)
          if (
            (!e && s.particleFillColor && (e = V(s.particleFillColor(t))),
            !i && s.particleStrokeColor && (i = V(s.particleStrokeColor(t))),
            e && i)
          )
            break;
        return [e, i];
      ...
      lineStyle(t, e) {
        return this.draw((i) => {
          const s = this.container.actualOptions.interactivity.modes.connect;
          return ft(i, t, e, s.links.opacity);
        });
      }
    }
    class Nt {
      ...
      load(t) {
        ...
        void 0 !== o &&
          (o instanceof Array
            ...
            : ((this.onDiv = new Kt()), this.onDiv.load(o))),
          this.onHover.load(
    ...
    class de {
      constructor() {
        (this.distance = 100), (this.links = new he());
      }
      get line_linked() {
        return this.links;
      }
    ...
    class ze {
      ...
      load(t) {
        ...
        void 0 !== o && (this.detectsOn = o),
          ...
          !0 ===
            (null ===
              (s = null === (i = t.modes) || void 0 === i ? void 0 : i.slow) ||
            void 0 === s
              ? void 0
              : s.active) &&
    ...
    class Te {
      constructor() {
        (this.disable = !1), (this.reduce = new Ce());
      }
      load(t) {
        t &&
    ...
    class Ee {
      constructor() {
        (this.angle = new Re()), (this.colors = []), (this.type = "random");
      }
      load(t) {
        t &&
    ...
    class Ae {
      constructor() {
        (this.value = 0), (this.animation = new Le());
      }
      load(t) {
        t &&
          (this.animation.load(t.animation),
    ...
    class De {
      constructor() {
        (this.stop = 0), (this.value = new Ie());
      }
      load(t) {
        t &&
          (void 0 !== t.stop && (this.stop = t.stop),
          (this.value = Ie.create(this.value, t.value)),
          void 0 !== t.opacity &&
            ((this.opacity = new Ae()),
    ...
    class He {
      constructor() {
        (this.random = new qe()), (this.value = 0);
      }
      load(t) {
        t &&
    ...
    class Je {
      constructor() {
        (this.mode = "none"), (this.split = new $e());
      }
      load(t) {
        t &&
    ...
    class Ye {
      constructor() {
        (this.count = 0), (this.delay = new Ne()), (this.duration = new Xe());
      }
      load(t) {
        void 0 !== t &&
          (void 0 !== t.count && (this.count = t.count),
        ...
        void 0 !== t &&
          (t instanceof Array
            ? (this.options[e] instanceof Array ||
                ((this.options[e] = []),
                (this.options[i] && !s) || (this.options[i] = [])),
              (this.options[e] = S(
                null !== (o = this.options[e]) && void 0 !== o ? o : [],
                t
              )),
              (this.options[i] && !s) ||
                (this.options[i] = S(
    ...
    class zi {
      ...
      load(t) {
        void 0 !== t &&
          (void 0 !== t.color && (this.color = Ie.create(this.color, t.color)),
          void 0 !== t.width && (this.width = t.width),
          void 0 !== t.opacity && (this.opacity = t.opacity));
      }
    }
      ...
      load(t) {
        ...
        if ((void 0 !== c && this.links.load(c), void 0 !== t.groups))
          for (const e in t.groups) {
            ...
            void 0 !== i &&
              (this.groups[e] = S(
                null !== (s = this.groups[e]) && void 0 !== s ? s : {},
                i
              ));
          }
        ...
        const h =
          null !==
            (n =
              null === (o = t.move) || void 0 === o ? void 0 : o.collisions) &&
          void 0 !== n
            ? n
        ...
        d &&
          (d instanceof Array
            ...
            : (this.stroke instanceof Array && (this.stroke = new zi()),
              this.stroke.load(d)));
        const u = t.gradient;
        u &&
          (u instanceof Array
    ...
    class _i {
      constructor(t) {
        Fi.add(this),
          ...
          Hi(this, Li, t, "f"),
          (this.autoPlay = !0),
          (this.background = new Xt()),
          (this.backgroundMask = new Ut()),
          (this.fullScreen = new Qt()),
          (this.detectRetina = !0),
          (this.duration = 0),
          (this.fpsLimit = 120),
          (this.interactivity = new ze()),
      ...
      load(t) {
        ...
        if (
          ...
          Vi(this, Li, "f").plugins.loadOptions(this, t),
          void 0 !== t.responsive)
        )
        ...
        (this.defaultDarkTheme =
          null === (o = Vi(this, Fi, "m", qi).call(this, "dark")) ||
          void 0 === o
            ? void 0
            : o.name),
          (this.defaultLightTheme =
            null === (n = Vi(this, Fi, "m", qi).call(this, "light")) ||
            void 0 === n
              ? void 0
              : n.name);
      }
      setTheme(t) {
        if (t) {
          ...
          const t =
              ...
              matchMedia("(prefers-color-scheme: dark)"),
            e = t && t.matches,
            i = Vi(this, Fi, "m", qi).call(this, e ? "dark" : "light");
      ...
      importPreset(t) {
        this.load(Vi(this, Li, "f").plugins.getPreset(t));
      }
    }
    (Li = new WeakMap()),
      (Fi = new WeakSet()),
    ...
    class $i {
      constructor(t, e, s, l, h, v) {
        var p, f, m, y, g, w, b, x, k;
        (this.id = e),
          (this.container = s),
          (this.group = v),
          Wi.set(this, void 0),
        ...
        const M = s.retina.pixelRatio,
          P = s.actualOptions,
          C = new Ei();
        C.load(P.particles);
        const T = C.shape.type,
          S = C.reduceDuplicates;
        if (
          ((this.shape = T instanceof Array ? z(T, this.id, S) : T),
          null == h ? void 0 : h.shape)
        ) {
          if (h.shape.type) {
            const t = h.shape.type;
            this.shape = t instanceof Array ? z(t, this.id, S) : t;
          }
          const t = new xi();
          t.load(h.shape),
            this.shape && (this.shapeData = this.loadShapeData(t, S));
        } else this.shapeData = this.loadShapeData(C.shape, S);
        void 0 !== h && C.load(h),
          void 0 !==
        ...
        const I = this.options.size,
          E = I.value;
        this.size = {
          enable: I.animation.enable,
          value: c(I) * s.retina.pixelRatio,
          max: r(E) * M,
          min: a(E) * M,
          loops: 0,
        ...
        if (R.enable) {
          ...
          (this.size.velocity =
            ((null !== (b = this.retina.sizeAnimationSpeed) && void 0 !== b
              ? b
              : s.retina.sizeAnimationSpeed) /
              100) *
        ...
        (this.direction = u(this.options.move.direction)),
          ...
          (this.position = this.calcPosition(s, l, i(O, 0, s.zLayers))),
          (this.initialPosition = this.position.copy()),
          (this.offset = Gt.origin);
        const A = s.particles;
        (A.needsSort = A.needsSort || A.lastZIndex < this.position.z),
          ...
          (this.sides = 24);
        let D = s.drawers.get(this.shape);
        D ||
          ((D = ji(this, Wi, "f").plugins.getShapeDrawer(this.shape)),
          D && s.drawers.set(this.shape, D)),
          (null == D ? void 0 : D.loadShape) &&
            (null == D || D.loadShape(this));
        const F = null == D ? void 0 : D.getSidesCount;
        if (
          (F && (this.sides = F(this)),
          ...
          const t =
              null !== (x = this.options.move.spin.position) && void 0 !== x
                ...
                : { x: 50, y: 50 },
            e = {
              x: (t.x / 100) * s.canvas.size.width,
              y: (t.y / 100) * s.canvas.size.height,
            },
            i = d(this.getPosition(), e);
          this.spin = {
            center: e,
        ...
        this.shadowColor = H(this.options.shadow.color);
        for (const t of s.particles.updaters) t.init && t.init(this);
        D && D.particleInit && D.particleInit(s, this);
        for (const [, t] of s.plugins)
      ...
      getFillColor() {
        ...
        if (s && this.roll && (this.backColor || this.roll.alter)) {
          if (
            ...
            if (this.roll.alter)
              return Mt(s, this.roll.alter.type, this.roll.alter.value);
          }
        }
        return s;
      }
      ...
      calcPosition(t, e, i, s = 0) {
        ...
        for (const [, s] of t.plugins) {
          const t =
            void 0 !== s.particlePosition
              ...
              : void 0;
          if (void 0 !== t) return $t.create(t.x, t.y, i);
        }
        const h = t.canvas.size,
          d = $t.create(
        ...
        return (
          ...
          this.checkOverlap(d, s) ? this.calcPosition(t, void 0, i, s + 1) : d
        );
      }
      checkOverlap(t, e = 0) {
        ...
        for (const e of this.container.particles.array)
          if (d(t, e.position) < s + e.getRadius()) {
            a = !0;
            break;
          }
        return a;
      ...
      calculateVelocity() {
        const t = v(this.direction).copy(),
          ...
          n = { left: s - i / 2, right: s + i / 2 };
        return (
          e.straight || (t.angle += o(l(n.left, n.right))),
      ...
      loadShapeData(t, e) {
        ...
        if (i) return S({}, i instanceof Array ? z(i, this.id, e) : i);
      }
      loadLife() {
        const t = this.container,
          e = this.options,
    ...
    class Yi {
      constructor(t, e) {
        (this.container = e),
          ...
          (this.interactionManager = new Lt(Xi(this, Ji, "f"), e));
        ...
        (this.linksColors = new Map()),
          ...
          (this.updaters = Xi(this, Ji, "f").plugins.getUpdaters(e, !0));
      }
      get count() {
      ...
      async update(t) {
        ...
        for (const s of this.array) {
          ...
          o && ((s.position.x *= o.width), (s.position.y *= o.height)),
            (s.bubble.inRange = !1);
          for (const [, e] of this.container.plugins) {
          ...
          this.mover.move(s, t),
            s.destroyed
              ? i.push(s)
              : this.quadTree.insert(new Bt(s.getPosition(), s));
        }
      ...
      addParticle(t, e, i) {
        const s = this.container,
          o = s.actualOptions.particles.number.limit * s.density;
        if (o > 0) {
      ...
      addSplitParticle(t) {
        ...
        return this.pushParticle(
          ...
          (e) =>
            !(e.size.value < 0.5) &&
            ((e.velocity.length = o(l(t.velocity.length, e.velocity.length))),
      ...
      getLinkFrequency(t, e) {
        ...
        return (
          void 0 === o && ((o = Math.random()), this.freqs.links.set(s, o)), o
        );
      }
      ...
      applyDensity(t, e, i) {
        ...
        if (
          ...
          return;
        const o = t.number,
          n = this.initDensityFactor(o.density),
          a = o.value,
      ...
      pushParticle(t, e, i, s) {
        try {
          ...
          let n = !0;
          if ((s && (n = s(o)), !n)) return;
          return this.array.push(o), this.zArray.push(o), this.nextId++, o;
        } catch (t) {
    ...
    class Ui {
      ...
      init() {
        const t = this.container,
          e = t.actualOptions;
        this.pixelRatio = !e.detectRetina || g() ? 1 : window.devicePixelRatio;
        const i = this.container.actualOptions.motion;
        if (i && (i.disable || i.reduce.value))
          if (g() || "undefined" == typeof matchMedia || !matchMedia)
            this.reduceFactor = 1;
          else {
        ...
        const o = e.particles;
        (this.attractDistance = o.move.attract.distance * s),
          (this.linksDistance = o.links.distance * s),
          (this.linksWidth = o.links.width * s),
          (this.sizeAnimationSpeed = o.size.animation.speed * s),
          (this.maxSpeed = o.move.gravity.maxSpeed * s),
          void 0 !== o.orbit.radius &&
            (this.orbitRadius =
              o.orbit.radius * this.container.retina.pixelRatio);
        const n = e.interactivity.modes;
        (this.connectModeDistance = n.connect.distance * s),
          (this.connectModeRadius = n.connect.radius * s),
          (this.grabModeDistance = n.grab.distance * s),
          (this.repulseModeDistance = n.repulse.distance * s),
          (this.bounceModeDistance = n.bounce.distance * s),
          (this.attractModeDistance = n.attract.distance * s),
          (this.slowModeRadius = n.slow.radius * s),
          (this.bubbleModeDistance = n.bubble.distance * s),
          n.bubble.size && (this.bubbleModeSize = n.bubble.size * s);
      }
      initParticle(t) {
        const e = t.options,
          i = this.pixelRatio,
          s = e.move.distance,
          o = t.retina;
        (o.attractDistance = e.move.attract.distance * i),
          (o.linksDistance = e.links.distance * i),
          (o.linksWidth = e.links.width * i),
          (o.moveDrift = n(e.move.drift) * i),
          (o.moveSpeed = n(e.move.speed) * i),
          (o.sizeAnimationSpeed = e.size.animation.speed * i),
          t.spin && (o.spinAcceleration = n(e.move.spin.acceleration) * i);
        ...
        (a.horizontal = void 0 !== s.horizontal ? s.horizontal * i : void 0),
          ...
          (o.maxSpeed = e.move.gravity.maxSpeed * i);
      }
    ...
    class ts {
      constructor(t, e, i, ...s) {
        (this.id = e),
          ...
          (this.particles = new Yi(Ki(this, Qi, "f"), this)),
          (this.drawer = new Rt(this)),
          (this.presets = s),
          (this.pathGenerator = {
            generate: () => {
              const t = Gt.create(0, 0);
              return (
          ...
          (this.drawers = new Map()),
          (this.density = 1),
          (this._options = new _i(Ki(this, Qi, "f"))),
          (this.actualOptions = new _i(Ki(this, Qi, "f"))),
          (this.eventListeners = new It(this)),
      ...
      pause() {
        if (
          (void 0 !== this.drawAnimationFrame &&
            (b()(this.drawAnimationFrame), delete this.drawAnimationFrame),
          !this.paused)
        ) {
      ...
      draw(t) {
        let e = t;
        this.drawAnimationFrame = w()(async (t) => {
        ...
        if (t)
          if ("function" == typeof t)
            ...
            (this.pathGenerator = t),
              (s = this.pathGenerator).generate || (s.generate = e.generate),
      ...
      exportImage(t, e, i) {
        var s;
        return null === (s = this.canvas.element) || void 0 === s
          ? void 0
          : s.toBlob(t, null != e ? e : "image/png", i);
      }
      exportConfiguration() {
      ...
      reset() {
        return (this._options = new _i(Ki(this, Qi, "f"))), this.refresh();
      }
      stop() {
        if (this.started) {
          (this.firstStart = !0),
        ...
        e.addEventListener("click", (t) => {
          ...
          e.addEventListener("touchend", (t) => {
            ...
            if (!this.destroyed) {
              if (s && !o) {
                const s = t;
                let o = s.touches[s.touches.length - 1];
                if (
                  !o &&
                  ((o = s.changedTouches[s.changedTouches.length - 1]), !o)
                )
                  return;
                const r =
                ...
                i(t, l, Math.max(o.radiusX, o.radiusY));
              }
              (s = !1), (o = !1);
            }
          }),
          e.addEventListener("touchcancel", () => {
            this.destroyed || ((s = !1), (o = !1));
          });
      }
      updateActualOptions() {
    ...
    class os {
      constructor(t) {
        es.set(this, void 0), is(this, es, t, "f");
      }
      dom() {
        return ss(this, es, "f").domArray;
      }
      domItem(t) {
        const e = this.dom(),
          i = e[t];
      ...
      async loadOptions(t) {
        ...
        r ||
          ...
          null === (s = document.querySelector("body")) ||
            void 0 === s ||
            s.append(r));
        const l = n instanceof Array ? z(n, a) : n,
          c = this.dom(),
          h = c.findIndex((t) => t.id === o);
        if (h >= 0) {
        ...
        if ("canvas" === r.tagName.toLowerCase())
          (d = r), (d.dataset[St.generatedAttribute] = "false");
        else {
          const t = r.getElementsByTagName("canvas");
          t.length
            ? ((d = t[0]), (d.dataset[St.generatedAttribute] = "false"))
            : ((d = document.createElement("canvas")),
              (d.dataset[St.generatedAttribute] = "true"),
              (d.style.width = "100%"),
              (d.style.height = "100%"),
              r.appendChild(d));
        }
        const u = new ts(ss(this, es, "f"), o, l);
        return (
          h >= 0 ? c.splice(h, 0, u) : c.push(u),
          u.canvas.loadCanvas(d),
          await u.start(),
          u
        );
      }
      ...
      async loadJSON(t, e, i) {
        let s, o;
        return (
          "number" == typeof e || void 0 === e ? (s = t) : ((o = t), (s = e)),
          this.loadRemoteOptions({ tagId: o, url: s, index: i })
        );
      }
      async setJSON(t, e, i, s) {
        ...
        return (
          t instanceof HTMLElement
            ? ((r = t), (o = e), (a = i))
            : ((n = t), (r = e), (o = i), (a = s)),
          this.loadRemoteOptions({ tagId: n, url: o, index: a, element: r })
        );
      }
      setOnClickHandler(t) {
        const e = this.dom();
    ...
    class cs {
      constructor() {
        ns.set(this, void 0),
          ...
          rs(this, ns, !1, "f"),
          (this.domArray = []),
          rs(this, as, new os(this), "f"),
          (this.plugins = new Wt(this));
      }
      init() {
        ls(this, ns, "f") || rs(this, ns, !0, "f");
      }
      async loadFromArray(t, e, i) {
        return ls(this, as, "f").load(t, e, i);
      }
      async load(t, e) {
        return ls(this, as, "f").load(t, e);
      }
      async set(t, e, i) {
        return ls(this, as, "f").set(t, e, i);
      }
      async loadJSON(t, e, i) {
        return ls(this, as, "f").loadJSON(t, e, i);
      }
      async setJSON(t, e, i, s) {
        return ls(this, as, "f").setJSON(t, e, i, s);
      }
      setOnClickHandler(t) {
        ls(this, as, "f").setOnClickHandler(t);
      }
      dom() {
        return ls(this, as, "f").dom();
      }
      domItem(t) {
        return ls(this, as, "f").domItem(t);
      }
      async refresh() {
      ...
      async addShape(t, e, i, s, o) {
        ...
        (n =
          "function" == typeof e
            ? { afterEffect: s, destroy: o, draw: e, init: i }
            : e),
    ...
    const hs = new cs();
    hs.init();
    const { particlesJS: ds, pJSDom: us } = ((t) => {
