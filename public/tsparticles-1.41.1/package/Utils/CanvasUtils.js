...
exports.alterHsl =
  exports.drawEllipse =
  exports.drawParticlePlugin =
  exports.drawPlugin =
  exports.drawShapeAfterEffect =
  exports.drawShape =
  exports.drawParticle =
  exports.drawGrabLine =
  exports.gradient =
  exports.drawConnectLine =
  exports.drawLinkTriangle =
  exports.drawLinkLine =
  exports.clear =
  exports.paintBase =
    void 0;
...
function drawLinkTriangle(
  ...
  context.fillStyle = (0, ColorUtils_1.getStyleFromRgb)(
    colorTriangle,
    opacityTriangle
  );
  context.fill();
...
function gradient(context, p1, p2, opacity) {
  ...
  const midRgb = (0, ColorUtils_1.colorMix)(
    color1,
    color2,
    p1.getRadius(),
    p2.getRadius()
  ...
  grad.addColorStop(
    ...
    (0, ColorUtils_1.getStyleFromRgb)(midRgb, opacity)
  );
...
function drawParticle(
  ...
  if (tiltOptions.enable || rollOptions.enable) {
    ...
    const rollVertical =
      roll && (rollOptions.mode === "vertical" || rollOptions.mode === "both");
  ...
  const angle =
    ((_b =
      (_a = particle.rotate) === null || _a === void 0 ? void 0 : _a.value) !==
      null && _b !== void 0
      ? _b
  ...
  if (gradient) {
    ...
    for (const color of gradient.colors) {
      fillGradient.addColorStop(
        color.stop,
        (0, ColorUtils_1.getStyleFromHsl)(
          {
...
function drawEllipse(
  ...
  const pos = particle.getPosition();
  if (fillColorValue) {
    context.strokeStyle = (0, ColorUtils_1.getStyleFromHsl)(
      fillColorValue,
      opacity
    );
  }
