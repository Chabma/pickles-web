...
export class Container {
  constructor(engine, id, sourceOptions, ...presets) {
    ...
    this.particles = new Particles(
      __classPrivateFieldGet(this, _Container_engine, "f"),
      this
    );
  ...
  async init() {
    ...
    for (const preset of this.presets) {
      this._options.load(
        __classPrivateFieldGet(this, _Container_engine, "f").plugins.getPreset(
          preset
        )
      );
    }
    const shapes = __classPrivateFieldGet(
      this,
      _Container_engine,
      "f"
    ).plugins.getSupportedShapes();
    for (const type of shapes) {
      const drawer = __classPrivateFieldGet(
        this,
        _Container_engine,
        "f"
    ...
    const availablePlugins = __classPrivateFieldGet(
      this,
      _Container_engine,
      "f"
