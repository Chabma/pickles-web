    ...
    class i {
      ...
      init(e) {
        ...
        a.enable &&
          ...
          a.sync || (e.rotate.velocity *= Math.random()));
      }
      isEnabled(e) {
        const t = e.options.rotate,
          o = t.animation;
        return !e.destroyed && !e.spawning && !t.path && o.enable;
      }
      update(e, t) {
        this.isEnabled(e) &&
          (function (e, t) {
            ...
            const a = e.options.rotate.animation,
              r =
                (null !== (o = n.velocity) && void 0 !== o ? o : 0) * t.factor,
              i = 2 * Math.PI;
            if (a.enable)
              switch (n.status) {
                case 0:
                  (n.value += r), n.value > i && (n.value -= i);
                  break;
                case 1:
                default:
                  (n.value -= r), n.value < 0 && (n.value += i);
              }
          })(e, t);
      }
    }
    async function u(e) {
      await e.addParticleUpdater("angle", (e) => new i(e));
    }
    return t;
  })();
});
