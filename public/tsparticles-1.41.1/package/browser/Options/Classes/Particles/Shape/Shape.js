...
export class Shape {
  ...
  get image() {
    var _a;
    return (_a = this.options["image" /* image */]) !== null && _a !== void 0
      ? _a
  ...
  get character() {
    var _a;
    return (_a = this.options["character" /* character */]) !== null &&
      _a !== void 0
      ? _a
      : this.options["char" /* char */];
  }
  /**
   * @deprecated this property was integrated in custom shape management
   */
  ...
  get polygon() {
    var _a;
    return (_a = this.options["polygon" /* polygon */]) !== null &&
      _a !== void 0
      ? _a
      : this.options["star" /* star */];
  }
  /**
   * @deprecated this property was integrated in custom shape management
   */
