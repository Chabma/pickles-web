...
export class ParticlesMover {
    ...
    const container = this.container,
      ...
      baseSpeed =
        ((_a = (_d = particle.retina).moveSpeed) !== null && _a !== void 0
          ? _a
          : (_d.moveSpeed =
              getRangeValue(moveOptions.speed) * container.retina.pixelRatio)) *
      ...
      maxSize =
        getRangeMax(particleOptions.size.value) * container.retina.pixelRatio,
  ...
  spin(particle, moveSpeed) {
    ...
    const updateFunc = {
      x:
        particle.spin.direction === "clockwise" /* clockwise */
          ? Math.cos
          : Math.sin,
      y:
        particle.spin.direction === "clockwise" /* clockwise */
