      ...
      getFillColor() {
        ...
        if (o && this.roll && (this.backColor || this.roll.alter)) {
          if (
            ...
            if (this.roll.alter)
              return Ot(o, this.roll.alter.type, this.roll.alter.value);
          }
        }
        return o;
      }
    ...
    class Do {
      constructor(t, e, i, o, s) {
        ...
        (this.emitters = e),
          ...
          (this.name = this.options.name),
          (this.shape =
            null === (a = Io(this, Ro, "f").emitterShapeManager) || void 0 === a
              ? void 0
              : a.getShape(this.options.shape)),
          (this.fill = this.options.fill),
          Ao(this, So, !this.options.life.wait, "f"),
          Ao(this, Oo, !1, "f");
        let u = L({}, this.options.particles);
        null != u || (u = {}),
          (null !== (r = u.move) && void 0 !== r) || (u.move = {}),
          (null !== (l = (h = u.move).direction) && void 0 !== l) ||
            (h.direction = this.options.direction),
