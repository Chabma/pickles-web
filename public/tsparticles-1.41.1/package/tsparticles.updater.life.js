  ...
  return (function () {
    ...
    class LifeUpdater {
      ...
      update(particle, delta) {
        ...
        const canvasSize = this.container.canvas.size,
          widthRange = NumberUtils_setRangeValue(0, canvasSize.width),
          heightRange = NumberUtils_setRangeValue(0, canvasSize.width);
        ...
        life.duration =
          NumberUtils_getRangeValue(lifeOptions.duration.value) * 1e3;
      }
    }
