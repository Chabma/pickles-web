...
try {
  ...
  if (dependencies["react-particles-js"]) {
    console.error(
      "\x1b[31m%s\x1b[0m",
      "The package react-particles-js has been deprecated and is not supported anymore. Please consider switching to react-tsparticles package."
    );
  ...
  if (dependencies["react"] || dependencies["next"]) {
    if (!dependencies["react-tsparticles"]) {
      console.warn(
        ...
        "Found React installed. Please download react-tsparticles to use tsParticles with a component ready to use and easier to configure."
      );
      console.log(
  ...
  if (dependencies["@angular/core"]) {
    if (!dependencies["ng-particles"]) {
      ...
      console.log(
        "You can read more about the component here: https://github.com/matteobruni/tsparticles/blob/main/components/angular/README.md"
      );
    }
  }
  ...
  if (dependencies["vue"] || dependencies["nuxt"]) {
    ...
    if (vueMajor > 2) {
      if (!dependencies["particles.vue3"]) {
        console.warn(
          "\x1b[43m\x1b[30m%s\x1b[0m",
          "Found Vue 3.x installed. Please Download particles.vue3 to use tsParticles with a component ready to use and easier to configure."
        );
        console.log(
      ...
      if (!dependencies["particles.vue"]) {
        console.warn(
          "\x1b[43m\x1b[30m%s\x1b[0m",
          "Found Vue 2.x installed. Please Download particles.vue to use tsParticles with a component ready to use and easier to configure."
        );
        console.log(
