...
!(function (t, i) {
  ...
  return (function () {
    ...
    class r {
      ...
      add(t) {
        return r.create(this.x + t.x, this.y + t.y);
      }
      addTo(t) {
      ...
      mult(t) {
        return r.create(this.x * t, this.y * t);
      }
      multTo(t) {
        (this.x *= t), (this.y *= t);
      }
    ...
    function n(t) {
      const i = h(t);
      let s = l(t);
      return i === s && (s = 0), Math.random() * (i - s) + s;
    }
    function a(t) {
    ...
    function d(t, i) {
      ...
      const s = l(t),
        e = h(t);
      return void 0 !== i
        ? { min: Math.min(s, i), max: Math.max(e, i) }
        : d(s, e);
    }
    function c(t, i) {
      const s = t.x - i.x,
        e = t.y - i.y;
      return { dx: s, dy: e, distance: Math.sqrt(s * s + e * e) };
    }
    function u(t, i) {
      return c(t, i).distance;
    }
    function b(t, i) {
      ...
      }
      {
        const i = /^#?([a-f\d])([a-f\d])([a-f\d])([a-f\d])?$/i,
          s = t.replace(
            i,
            (t, i, s, e, o) =>
              i + i + s + s + e + e + (void 0 !== o ? o + o : "")
          ),
          e = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i.exec(s);
        return e
          ? {
    ...
    function p(t, i, s = !0) {
      ...
      if ("string" == typeof a.value)
        l =
          a.value === o.randomColorValue
            ? M()
            : (function (t) {
                return g(t);
              })(a.value);
      else if (a.value instanceof Array) {
        l = p({ value: v(a.value, i, s) });
      } else {
        const t = a.value,
          i = null !== (e = t.rgb) && void 0 !== e ? e : a.value;
        if (void 0 !== i.r) l = i;
        else {
          const i = null !== (r = t.hsl) && void 0 !== r ? r : a.value;
          if (void 0 !== i.h && void 0 !== i.l) l = m(i);
          else {
            const i = null !== (n = t.hsv) && void 0 !== n ? n : a.value;
            void 0 !== i.h && void 0 !== i.v && (l = x(i));
          }
        }
      }
      return l;
    ...
    function m(t) {
      const i = { b: 0, g: 0, r: 0 },
        s = { h: t.h / 360, l: t.l / 100, s: t.s / 100 };
      if (0 === s.s) (i.b = s.l), (i.g = s.l), (i.r = s.l);
      else {
        const t = s.l < 0.5 ? s.l * (1 + s.s) : s.l + s.s - s.l * s.s,
          e = 2 * s.l - t;
        (i.r = f(e, t, s.h + 1 / 3)),
          (i.g = f(e, t, s.h)),
          (i.b = f(e, t, s.h - 1 / 3));
    ...
    function x(t) {
      ...
      if (
        (s >= 0 && s <= 1
          ...
          : s > 4 && s <= 5
          ? (a = { r: n, g: 0, b: r })
          : s > 5 && s <= 6 && (a = { r: r, g: 0, b: n }),
        a)
      ) {
        const t = o - r;
        (i.r = Math.floor(255 * (a.r + t))),
          (i.g = Math.floor(255 * (a.g + t))),
          (i.b = Math.floor(255 * (a.b + t)));
      }
      return i;
    }
    function M(t) {
      const i = null != t ? t : 0;
      return {
        b: Math.floor(n(d(i, 256))),
        g: Math.floor(n(d(i, 256))),
        r: Math.floor(n(d(i, 256))),
      };
    }
    new WeakMap();
    class w extends class {
      constructor() {
        (this.random = new e()), (this.value = 0);
      }
      load(t) {
        t &&
    ...
    class z {
      constructor(t, i, s, e) {
        ...
        (this.absorbers = t),
          (this.container = i),
          (this.initialPosition = e ? r.create(e.x, e.y) : void 0),
          s instanceof A
            ? (this.options = s)
            : ((this.options = new A()), this.options.load(s)),
          (this.dragging = !1),
          (this.name = this.options.name),
          (this.opacity = this.options.opacity),
          (this.size = a(this.options.size.value) * i.retina.pixelRatio),
          (this.mass =
            this.size * this.options.size.density * i.retina.reduceFactor);
        const h = this.options.size.limit;
        (this.limit = {
          radius: h.radius * i.retina.pixelRatio * i.retina.reduceFactor,
          mass: h.mass,
        }),
          (this.color =
            null !== (o = p(this.options.color)) && void 0 !== o
              ? o
              : { b: 0, g: 0, r: 0 }),
          (this.position =
            null !==
      ...
      attract(t) {
        ...
        if (s.draggable) {
          ...
          if (t.clicking && t.downPosition) {
            u(this.position, t.downPosition) <= this.size &&
              (this.dragging = !0);
        ...
        const e = t.getPosition(),
          { dx: o, dy: n, distance: a } = c(this.position, e),
          l = r.create(o, n);
        if (
          ((l.length = (this.mass / Math.pow(a, 2)) * i.retina.reduceFactor),
          a < this.size + t.getRadius())
        ) {
          const e = 0.033 * t.getRadius() * i.retina.pixelRatio;
          ...
          (void 0 !== t.absorberOrbit && t.absorberOrbit.length < 0)
            ...
            (this.limit.mass <= 0 || this.mass < this.limit.mass) &&
              (this.mass +=
                e * this.options.size.density * i.retina.reduceFactor);
      ...
      resize() {
        ...
        this.position =
          ...
          (function (t, i, s) {
            let e = !0;
            return (
              (s && "bottom" !== s) || (e = t.top < i.height),
              !e || (s && "left" !== s) || (e = t.right > 0),
              !e || (s && "right" !== s) || (e = t.left < i.width),
              !e || (s && "top" !== s) || (e = t.bottom > 0),
              e
            );
          })(y(i, null != e ? e : 0), s, o))
            ? t
      ...
      updateParticlePosition(t, i) {
        ...
        if (
          (t.needsNewPosition &&
            ((t.position.x = Math.floor(Math.random() * o.width)),
            (t.position.y = Math.floor(Math.random() * o.height)),
          ...
          if (
            (void 0 === t.absorberOrbit &&
              ((t.absorberOrbit = r.create(0, 0)),
              (t.absorberOrbit.length = u(t.getPosition(), this.position)),
              (t.absorberOrbit.angle = Math.random() * Math.PI * 2)),
            t.absorberOrbit.length <= this.size && !this.options.destroy)
          ) {
            const i = Math.min(o.width, o.height);
          ...
          (t.position.x = this.position.x + n * h.x(a)),
            (t.position.y = this.position.y + n * h.y(a)),
            (t.absorberOrbit.length -= i.length),
            (t.absorberOrbit.angle +=
              (((null !== (s = t.retina.moveSpeed) && void 0 !== s ? s : 0) *
                e.retina.pixelRatio) /
                100) *
              e.retina.reduceFactor);
        } else {
          const s = r.origin;
          (s.length = i.length), (s.angle = i.angle), t.velocity.addTo(s);
        }
      }
    }
    class O {
      ...
      init(t) {
        ...
        t.absorbers &&
          (t.absorbers instanceof Array
            ...
            : (this.absorbers instanceof Array && (this.absorbers = new A()),
        ...
        if (
          (e &&
            (e instanceof Array
              ? (this.interactivityAbsorbers = e.map((t) => {
                  const i = new A();
                  return i.load(t), i;
                }))
              : (this.interactivityAbsorbers instanceof Array &&
                  (this.interactivityAbsorbers = new A()),
                this.interactivityAbsorbers.load(e))),
      ...
      handleClickMode(t) {
        const i = this.container,
          s = this.absorbers,
          e = this.interactivityAbsorbers;
        if ("absorber" === t) {
          let t;
          e instanceof Array ? e.length > 0 && (t = v(e)) : (t = e);
          const o = null != t ? t : s instanceof Array ? v(s) : s,
            r = i.interactivity.mouse.clickPosition;
          this.addAbsorber(o, r);
        }
      }
      addAbsorber(t, i) {
        const s = new z(this, this.container, t, i);
    ...
    class k {
          ...
          o instanceof Array
            ...
            : (void 0 !== o ||
                ((null ===
                  ...
                  ? void 0
                  : e.mode) &&
                  b("absorber", t.interactivity.events.onClick.mode))) &&
              (r = !0),
          r
        );
      }
      loadOptions(t, i) {
        ...
        const r =
          null ===
            (e =
              null === (s = null == i ? void 0 : i.interactivity) ||
              void 0 === s
                ? void 0
                : s.modes) || void 0 === e
            ? void 0
        ...
        if (r)
          if (r instanceof Array)
            ...
            void 0 === (null == t ? void 0 : t.load) &&
              (o.interactivity.modes.absorbers = t = new A()),
              t.load(r);
          }
      }
    }
