...
!(function (t, e) {
  ...
  return (function () {
    ...
    function a(t) {
      ...
      var n = (s[t] = { exports: {} });
      return r[t](n, n.exports, a), n.exports;
    }
    (a.m = r),
      (t = []),
      (a.O = function (e, n, i, o) {
        if (!n) {
          var r = 1 / 0;
          for (c = 0; c < t.length; c++) {
            (n = t[c][0]), (i = t[c][1]), (o = t[c][2]);
      ...
      (a.F = {}),
      (a.E = function (t) {
        Object.keys(a.F).map(function (e) {
          a.F[e](t);
        });
      }),
      ...
      (a.l = function (t, e, n, r) {
        if (i[t]) i[t].push(e);
          ...
          if (void 0 !== n)
            for (
              var h = document.getElementsByTagName("script"), c = 0;
              c < h.length;
              c++
            ) {
              var u = h[c];
      ...
      (function () {
        ...
        var e = function (e, n) {
            ...
            for (e && e(n); h < r.length; h++)
              (o = r[h]), a.o(t, o) && t[o] && t[o][0](), (t[o] = 0);
            return a.O(c);
          },
          n = (window.webpackChunktsparticles =
    ...
    class c {}
    (c.generatedAttribute = "generated"),
      (c.randomColorValue = "random"),
      (c.midColorValue = "mid"),
      (c.touchEndEvent = "touchend"),
      (c.mouseDownEvent = "mousedown"),
      (c.mouseUpEvent = "mouseup"),
      (c.mouseMoveEvent = "mousemove"),
      (c.touchStartEvent = "touchstart"),
      (c.touchMoveEvent = "touchmove"),
      (c.mouseLeaveEvent = "mouseleave"),
      (c.mouseOutEvent = "mouseout"),
      (c.touchCancelEvent = "touchcancel"),
      (c.resizeEvent = "resize"),
      (c.visibilityChangeEvent = "visibilitychange"),
      (c.noPolygonDataLoaded = "No polygon data loaded."),
      (c.noPolygonFound =
    ...
    class u {
      ...
      add(t) {
        return u.create(this.x + t.x, this.y + t.y);
      }
      addTo(t) {
      ...
      mult(t) {
        return u.create(this.x * t, this.y * t);
      }
      multTo(t) {
        (this.x *= t), (this.y *= t);
      }
    ...
    function d(t) {
      const e = f(t);
      let n = p(t);
      return e === n && (n = 0), Math.random() * (e - n) + n;
    }
    function p(t) {
    ...
    function v(t, e) {
      ...
      const n = p(t),
        i = f(t);
      return void 0 !== e
        ? { min: Math.min(n, e), max: Math.max(i, e) }
        : v(n, i);
    }
    function y(t, e) {
      const n = t.x - e.x,
      ...
      for (const n of e) {
        ...
        for (const e in n) {
          ...
          const i = n[e],
            o = "object" == typeof i,
            r = t;
          r[e] = o && Array.isArray(i) ? i.map((t) => m(r[e], t)) : m(r[e], i);
        }
      }
      return t;
    }
      ...
      }
      {
        const e = /^#?([a-f\d])([a-f\d])([a-f\d])([a-f\d])?$/i,
          n = t.replace(
            e,
            (t, e, n, i, o) =>
              e + e + n + n + i + i + (void 0 !== o ? o + o : "")
          ),
          i = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i.exec(n);
        return i
          ? {
    ...
    function P(t, e, n = !0) {
      ...
      if ("string" == typeof s.value)
        a =
          s.value === c.randomColorValue
            ? A()
            : (function (t) {
                return x(t);
              })(s.value);
      else if (s.value instanceof Array) {
        a = P({ value: w(s.value, e, n) });
      } else {
        const t = s.value,
          e = null !== (i = t.rgb) && void 0 !== i ? i : s.value;
        if (void 0 !== e.r) a = e;
        else {
          const e = null !== (o = t.hsl) && void 0 !== o ? o : s.value;
          if (void 0 !== e.h && void 0 !== e.l) a = E(e);
          else {
            const e = null !== (r = t.hsv) && void 0 !== r ? r : s.value;
            void 0 !== e.h && void 0 !== e.v && (a = T(e));
          }
        }
      }
      return a;
    ...
    function E(t) {
      ...
      if (0 === n.s) (e.b = n.l), (e.g = n.l), (e.r = n.l);
      else {
        const t = n.l < 0.5 ? n.l * (1 + n.s) : n.l + n.s - n.l * n.s,
          i = 2 * n.l - t;
        (e.r = b(i, t, n.h + 1 / 3)),
          (e.g = b(i, t, n.h)),
          (e.b = b(i, t, n.h - 1 / 3));
    ...
    function A(t) {
      const e = null != t ? t : 0;
      return {
        b: Math.floor(d(v(e, 256))),
        g: Math.floor(d(v(e, 256))),
        r: Math.floor(d(v(e, 256))),
      };
    }
    function S(t, e) {
    ...
    class _ {
      constructor() {
        (this.color = new h()), (this.width = 0.5), (this.opacity = 1);
      }
      load(t) {
        var e;
        t &&
          ((this.color = h.create(this.color, t.color)),
          "string" == typeof this.color.value &&
            (this.opacity =
              null !==
                (e = (function (t) {
                  var e;
                  return null === (e = x(t)) || void 0 === e ? void 0 : e.a;
                })(this.color.value)) && void 0 !== e
                ? e
                : this.opacity),
    ...
    class M {
      constructor() {
        (this.enable = !1), (this.stroke = new _());
      }
      get lineWidth() {
      ...
      set lineColor(t) {
        this.stroke.color = h.create(this.stroke.color, t);
      }
      load(t) {
        var e;
        if (!t) return;
    ...
    class R {
      ...
      load(t) {
        ...
        void 0 !== n && this.inline.load(n),
          ...
          void 0 !== t.position && (this.position = m({}, t.position));
      }
    }
    function C(t, e, n) {
      const i = P(n.color);
    ...
    function L(t, e, n, i) {
      ...
      const o = P(n.color);
      o &&
        ((t.strokeStyle = S(o, n.opacity)),
        (t.lineWidth = n.width),
        t.stroke(e));
    }
    function j(t, e, n) {
      const { dx: i, dy: o } = y(n, t),
        { dx: r, dy: s } = y(e, t),
        a = (i * r + o * s) / (r ** 2 + s ** 2),
        l = { x: t.x + r * a, y: t.x + s * a, isOnSegment: a >= 0 && a <= 1 };
      return (
        a < 0
          ? ((l.x = t.x), (l.y = t.y))
          : a > 1 && ((l.x = e.x), (l.y = e.y)),
    ...
    function B(t, e, n) {
      const { dx: i, dy: o } = y(t, e),
        r = Math.atan2(o, i),
        s = u.create(Math.sin(r), -Math.cos(r)),
        a = 2 * (n.x * s.x + n.y * s.y);
      s.multTo(a), n.subFrom(s);
    }
    class H {
      constructor(t) {
        (this.container = t),
      ...
      particlePosition(t) {
        ...
        if (
          this.options.enable &&
          (null !==
            (n = null === (e = this.raw) || void 0 === e ? void 0 : e.length) &&
          void 0 !== n
            ? n
            : 0) > 0
        )
          return m({}, t || this.randomPoint());
      }
      particleBounce(t, e, n) {
      ...
      draw(t) {
        ...
        for (const e of this.paths) {
          ...
          t &&
            (r && n && this.offset
              ? L(t, n, i.stroke, this.offset)
              : o && C(t, o, i.stroke));
        }
      }
      polygonBounce(t, e, n) {
        const i = this.options;
        if (!this.raw || !i.enable || "top" !== n) return !1;
        if ("inside" === i.type || "outside" === i.type) {
          let e, n, i;
          const o = t.getPosition(),
            r = t.getRadius();
          for (
            let s = 0, a = this.raw.length - 1;
            s < this.raw.length;
            a = s++
          ) {
            const l = this.raw[s],
            ...
            e = j(l, h, o);
            const c = y(o, e);
            if ((([n, i] = [c.dx, c.dy]), c.distance < r))
              return B(l, h, t.velocity), !0;
          }
          if (
            e &&
            void 0 !== n &&
            void 0 !== i &&
            !this.checkInsidePolygon(o)
          ) {
            const n = { x: 1, y: 1 };
            return (
              t.position.x >= e.x && (n.x = -1),
              t.position.y >= e.y && (n.y = -1),
              (t.position.x = e.x + 2 * r * n.x),
              (t.position.y = e.y + 2 * r * n.y),
              t.velocity.mult(-1),
              !0
            );
          }
        } else if ("inline" === i.type && t.initialPosition) {
          if (
            ((o = t.initialPosition), (r = t.getPosition()), y(o, r).distance) >
            this.polygonMaskMoveRadius
          )
            return (
      ...
      checkInsidePolygon(t) {
        ...
        const r = i.canvas.size,
          s =
            null !== (e = null == t ? void 0 : t.x) && void 0 !== e
              ...
              : Math.random() * r.width,
          a =
            null !== (n = null == t ? void 0 : t.y) && void 0 !== n
              ? n
        ...
        for (let t = 0, e = this.raw.length - 1; t < this.raw.length; e = t++) {
          const n = this.raw[t],
            i = this.raw[e];
          n.y > a != i.y > a &&
            s < ((i.x - n.x) * (a - n.y)) / (i.y - n.y) + n.x &&
            (l = !l);
        }
        return "inside" === o.type ? l : "outside" === o.type && !l;
      }
      parseSvgPath(t, e) {
        var n, i, o;
        const r = null != e && e;
        ...
        let c = h.getElementsByTagName("path");
        c.length || (c = l.getElementsByTagName("path")), (this.paths = []);
        for (let t = 0; t < c.length; t++) {
          const e = c.item(t);
          e && this.paths.push({ element: e, length: e.getTotalLength() });
        }
        const u = s.retina.pixelRatio,
          d = a.scale / u;
        (this.dimension.width =
          parseFloat(
            null !== (n = h.getAttribute("width")) && void 0 !== n ? n : "0"
          ) * d),
          (this.dimension.height =
            parseFloat(
              null !== (i = h.getAttribute("height")) && void 0 !== i ? i : "0"
            ) * d);
        const p =
          null !== (o = a.position) && void 0 !== o ? o : { x: 50, y: 50 };
        return (
          (this.offset = {
            x:
              (s.canvas.size.width * p.x) / (100 * u) -
              this.dimension.width / 2,
            y:
              (s.canvas.size.height * p.y) / (100 * u) -
          ...
          (function (t, e, n) {
            ...
            for (const r of t) {
              const t = r.element.pathSegList,
                s =
                  null !== (i = null == t ? void 0 : t.numberOfItems) &&
                  void 0 !== i
                    ? i
                    : 0,
                a = { x: 0, y: 0 };
              for (let i = 0; i < s; i++) {
                const r = null == t ? void 0 : t.getItem(i),
                  s = window.SVGPathSeg;
                switch (null == r ? void 0 : r.pathSegType) {
                ...
                o.push({ x: a.x * e + n.x, y: a.y * e + n.y });
              }
            }
            return o;
          })(this.paths, d, this.offset)
        );
      }
        ...
        if ("inline" === e.type)
          switch (e.inline.arrangement) {
            ...
            case "random-length":
              ...
              break;
            case "equidistant":
              n = this.getEquidistantPointByIndex(t.particles.count);
              break;
            case "one-per-point":
            case "per-point":
            default:
              n = this.getPointByIndex(t.particles.count);
          }
        else
          n = {
      ...
      getRandomPoint() {
        if (!this.raw || !this.raw.length)
          throw new Error(c.noPolygonDataLoaded);
        const t = w(this.raw);
        return { x: t.x, y: t.y };
      }
      getRandomPointByLength() {
        ...
        return {
          ...
          y:
            s.y * i.scale +
            ((null === (n = this.offset) || void 0 === n ? void 0 : n.y) || 0),
        };
      }
      getEquidistantPointByIndex(t) {
        ...
        for (const e of this.paths) {
          const n = p * t - d;
          if (n <= e.length) {
            u = e.element.getPointAtLength(n);
            break;
          }
          d += e.length;
        }
        return {
          x:
            (null !== (n = null == u ? void 0 : u.x) && void 0 !== n ? n : 0) *
              h.scale +
            (null !==
              (o = null === (i = this.offset) || void 0 === i ? void 0 : i.x) &&
            void 0 !== o
              ? o
              : 0),
          y:
            (null !== (r = null == u ? void 0 : u.y) && void 0 !== r ? r : 0) *
              h.scale +
            (null !==
              (a = null === (s = this.offset) || void 0 === s ? void 0 : s.y) &&
            void 0 !== a
              ? a
              : 0),
        };
          ...
          for (const t of this.paths) {
            ...
            if (i) {
              const e = new Path2D(i),
                ...
                r = new Path2D(),
                s = o.scale(n.scale);
              r.addPath ? (r.addPath(e, s), (t.path2d = r)) : delete t.path2d;
            } else delete t.path2d;
            !t.path2d &&
              this.raw &&
              ((t.path2d = new Path2D()),
              t.path2d.moveTo(this.raw[0].x, this.raw[0].y),
              this.raw.forEach((e, n) => {
                var i;
                n > 0 &&
                  (null === (i = t.path2d) ||
                    void 0 === i ||
          ...
          if ("string" != typeof n) {
            const t =
              n.path instanceof Array
                ? n.path.map((t) => `<path d="${t}" />`).join("")
                : `<path d="${n.path}" />`;
            i = `<svg ${'xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"'} width="${
              n.size.width
            }" height="${n.size.height}">${t}</svg>`;
          } else i = n;
          this.raw = this.parseSvgPath(i, t);
        }
        this.createPath2D();
      }
    }
        ...
        return null !==
          ...
          : void 0 !==
              (null === (i = null == t ? void 0 : t.polygon) || void 0 === i
                ? void 0
                : i.type) && "none" !== t.polygon.type;
      }
      loadOptions(t, e) {
        if (!this.needsPlugin(e)) return;
        const n = t;
        let i = n.polygon;
        void 0 === (null == i ? void 0 : i.load) && (n.polygon = i = new R()),
          i.load(null == e ? void 0 : e.polygon);
      }
    }
    async function G(t) {
      g() ||
        "SVGPathSeg" in window ||
        (await a.e(404).then(a.t.bind(a, 167, 23)));
      const e = new D();
      await t.addPlugin(e);
    }
    return (l = a.O(l));
