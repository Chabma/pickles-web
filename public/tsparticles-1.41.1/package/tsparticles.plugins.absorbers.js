  ...
  return (function () {
    ...
    class ValueWithRandom_ValueWithRandom {
      ...
      load(data) {
        ...
        if (data.value !== undefined) {
          this.value = NumberUtils_setRangeValue(
            data.value,
    ...
    class AbsorberInstance {
      constructor(absorbers, container, options, position) {
        ...
        this.initialPosition = position
          ? Vector_Vector.create(position.x, position.y)
          : undefined;
        ...
        this.size =
          NumberUtils_getRangeValue(this.options.size.value) *
          container.retina.pixelRatio;
        this.mass =
        ...
        this.color =
          (_a = ColorUtils_colorToRgb(this.options.color)) !== null &&
          _a !== void 0
            ? _a
            : {
                b: 0,
      ...
      attract(particle) {
        ...
        if (options.draggable) {
          ...
          if (mouse.clicking && mouse.downPosition) {
            const mouseDist = NumberUtils_getDistance(
              this.position,
              mouse.downPosition
            );
        ...
        const {
          ...
          dy: dy,
          distance: distance,
        } = NumberUtils_getDistances(this.position, pos);
      ...
      draw(context) {
        ...
        context.closePath();
        context.fillStyle = ColorUtils_getStyleFromRgb(
          this.color,
          this.opacity
        );
        context.fill();
      ...
      updateParticlePosition(particle, v) {
        ...
        if (this.options.orbits) {
          if (particle.absorberOrbit === undefined) {
            ...
            particle.absorberOrbit.length = NumberUtils_getDistance(
        ...
        if (mode === "absorber") {
          ...
          const absorbersOptions =
            absorbersModeOptions !== null && absorbersModeOptions !== void 0
              ...
              ? Utils_itemFromArray(absorberOptions)
              : absorberOptions;
      ...
      needsPlugin(options) {
        ...
        if (absorbers instanceof Array) {
          ...
          ((_c =
            ...
            ? void 0
            : _c.mode) &&
          Utils_isInArray("absorber", options.interactivity.events.onClick.mode)
        ) {
          loadAbsorbers = true;
        }
