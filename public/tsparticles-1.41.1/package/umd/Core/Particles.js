...
(function (factory) {
  ...
  class Particles {
    constructor(engine, container) {
      ...
      this.interactionManager = new Utils_1.InteractionManager(
        __classPrivateFieldGet(this, _Particles_engine, "f"),
        container
      );
      const canvasSize = this.container.canvas.size;
      this.linksColors = new Map();
      this.quadTree = new Utils_1.QuadTree(
      ...
      this.updaters = __classPrivateFieldGet(
        this,
        _Particles_engine,
        "f"
    ...
    async update(delta) {
      ...
      for (const particle of this.array) {
        ...
        this.quadTree.insert(
          new Utils_1.Point(particle.getPosition(), particle)
        );
      }
    ...
    addSplitParticle(parent) {
      ...
      const offset = splitOptions.sizeOffset
        ? (0, Utils_2.setRangeValue)(-parent.size.value, parent.size.value)
        : 0;
      const position = {
      ...
      return this.pushParticle(position, options, parent.group, (particle) => {
        ...
        particle.velocity.length = (0, Utils_2.randomInRange)(
          (0, Utils_2.setRangeValue)(
    ...
    getLinkFrequency(p1, p2) {
      const range = (0, Utils_2.setRangeValue)(p1.id, p2.id),
        key = `${(0, Utils_2.getRangeMin)(range)}_${(0, Utils_2.getRangeMax)(
          range
        )}`;
