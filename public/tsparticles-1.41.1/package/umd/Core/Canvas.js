  ...
  class Canvas {
    ...
    paint() {
      ...
      this.draw((ctx) => {
        if (
          ...
          (0, Utils_1.clear)(ctx, this.size);
          this.paintBase(
            (0, Utils_1.getStyleFromRgb)(this.coverColor, this.coverColor.a)
          );
        } else {
          this.paintBase();
        }
    ...
    clear() {
      ...
      if (options.backgroundMask.enable) {
        ...
        this.paintBase(
          (0, Utils_1.getStyleFromRgb)(this.trailFillColor, 1 / trail.length)
        );
      } else {
        this.draw((ctx) => {
          (0, Utils_1.clear)(ctx, this.size);
    ...
    drawParticle(particle, delta) {
      ...
      const fillColorValue = fColor
        ? (0, Utils_1.getStyleFromHsl)(fColor, zOpacity)
        : undefined;
      ...
      this.draw((ctx) => {
        ...
        const strokeColorValue = sColor
          ? (0, Utils_1.getStyleFromHsl)(sColor, zStrokeOpacity)
          : fillColorValue;
        if (radius <= 0) {
          return;
        }
    ...
    initBackground() {
      ...
      if (background.color) {
        ...
        elementStyle.backgroundColor = color
          ? (0, Utils_1.getStyleFromRgb)(color, background.opacity)
          : "";
      } else {
