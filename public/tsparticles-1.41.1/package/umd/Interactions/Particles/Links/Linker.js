(function (factory) {
  ...
  class Linker extends Core_1.ParticlesInteractorBase {
    ...
    async interact(p1) {
      ...
      const range = warp
        ? new Core_1.CircleWarp(pos1.x, pos1.y, optDistance, canvasSize)
        : new Core_1.Circle(pos1.x, pos1.y, optDistance);
    ...
    setColor(p1) {
      ...
      if (!linkColor) {
        ...
        linkColor = (0, Utils_1.getLinkRandomColor)(
          optColor,
          linksOptions.blink,
