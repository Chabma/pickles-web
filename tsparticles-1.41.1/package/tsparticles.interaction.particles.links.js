  ...
  return (function () {
    ...
    class CircleWarp_CircleWarp extends Circle_Circle {
      ...
      intersects(range) {
        ...
        if (circle.radius !== undefined) {
          const biggerCircle = new Circle_Circle(
            newPos.x,
            newPos.y,
            circle.radius * 2
          );
          ...
          const rectSW = new Rectangle_Rectangle(
            newPos.x,
            newPos.y,
            rect.size.width * 2,
            rect.size.height * 2
    ...
    class Linker extends ParticlesInteractorBase {
      ...
      async interact(p1) {
        ...
        const range = warp
          ...
          : new Circle_Circle(pos1.x, pos1.y, optDistance);
    ...
    class LinkInstance {
      ...
      drawLinkTriangle(p1, link1, link2) {
        ...
        container.canvas.draw((ctx) => {
          if (
            NumberUtils_getDistance(pos1, pos2) >
              container.retina.linksDistance ||
            NumberUtils_getDistance(pos3, pos2) >
              container.retina.linksDistance ||
            NumberUtils_getDistance(pos3, pos1) > container.retina.linksDistance
          ) {
            return;
          }
