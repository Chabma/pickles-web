...
export class Options {
  ...
  load(data) {
    ...
    __classPrivateFieldGet(this, _Options_engine, "f").plugins.loadOptions(
      this,
      data
    );
    ...
    this.defaultDarkTheme =
      (_d = __classPrivateFieldGet(
        this,
        _Options_instances,
        "m",
        _Options_findDefaultTheme
      ).call(this, "dark" /* dark */)) === null || _d === void 0
        ? void 0
        : _d.name;
    this.defaultLightTheme =
      (_e = __classPrivateFieldGet(
        this,
        _Options_instances,
        "m",
        _Options_findDefaultTheme
      ).call(this, "light" /* light */)) === null || _e === void 0
        ? void 0
        : _e.name;
  }
  setTheme(name) {
    if (name) {
      ...
      const mediaMatch =
        ...
        defaultTheme = __classPrivateFieldGet(
          this,
          _Options_instances,
          "m",
          _Options_findDefaultTheme
        ).call(this, clientDarkMode ? "dark" /* dark */ : "light" /* light */);
      if (defaultTheme) {
  ...
  importPreset(preset) {
    this.load(
      __classPrivateFieldGet(this, _Options_engine, "f").plugins.getPreset(
        preset
      )
    );
  }
...
(_Options_engine = new WeakMap()),
  ...
  (_Options_findDefaultTheme = function _Options_findDefaultTheme(mode) {
    ...
    return (_a = this.themes.find(
      ...
      : this.themes.find(
          (theme) =>
            theme.default.value && theme.default.mode === "any" /* any */
        );
  });
