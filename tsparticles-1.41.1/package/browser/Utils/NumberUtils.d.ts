...
export declare function setRangeValue(
  source: RangeValue,
  value?: number
): RangeValue;
 ...
 */
export declare function getDistances(
  pointA: ICoordinates,
  pointB: ICoordinates
): {
  dx: number;
 ...
 * @param pointB the second coordinate
 */
export declare function getDistance(
  pointA: ICoordinates,
  pointB: ICoordinates
): number;
export declare function getParticleDirectionAngle(
  direction:
    | MoveDirection
...
export declare function collisionVelocity(
  v1: Vector,
  v2: Vector,
  m1: number,
  m2: number
