...
export class Repulser extends ExternalInteractorBase {
  ...
  isEnabled() {
    const container = this.container,
      ...
      divs = events.onDiv,
      divRepulse = isDivModeEnabled("repulse" /* repulse */, divs);
    if (
      !(
        divRepulse ||
    ...
    return (
      isInArray("repulse" /* repulse */, hoverMode) ||
      isInArray("repulse" /* repulse */, clickMode) ||
      divRepulse
    );
  }
  reset() {
  ...
  async interact() {
    ...
    if (
      ...
      divModeExecute("repulse" /* repulse */, divs, (selector, div) =>
