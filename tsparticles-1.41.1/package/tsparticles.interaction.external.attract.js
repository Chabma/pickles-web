  ...
  return (function () {
    ...
    class Attractor extends ExternalInteractorBase {
      ...
      isEnabled() {
        ...
        return (
          Utils_isInArray("attract", hoverMode) ||
          Utils_isInArray("attract", clickMode)
        );
      }
      reset() {}
      async interact() {
      ...
      hoverAttract() {
        ...
        this.processAttract(
          mousePos,
          attractRadius,
          new Circle_Circle(mousePos.x, mousePos.y, attractRadius)
        );
      }
