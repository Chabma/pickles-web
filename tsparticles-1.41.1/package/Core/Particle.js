...
const fixOutMode = (data) => {
  if (
    (0, Utils_2.isInArray)(data.outMode, data.checkModes) ||
    (0, Utils_2.isInArray)(data.outMode, data.checkModes)
  ) {
...
class Particle {
  constructor(engine, id, container, position, overrideOptions, group) {
    ...
    this.shape =
      shapeType instanceof Array
        ? (0, Utils_2.itemFromArray)(shapeType, this.id, reduceDuplicates)
        : shapeType;
    if (
    ...
    if (
      ...
      particlesOptions.load(
        (_b = this.shapeData) === null || _b === void 0 ? void 0 : _b.particles
      );
    }
    this.fill =
      (_d =
        (_c = this.shapeData) === null || _c === void 0 ? void 0 : _c.fill) !==
        null && _d !== void 0
        ? _d
        : this.fill;
    this.close =
      (_f =
        (_e = this.shapeData) === null || _e === void 0 ? void 0 : _e.close) !==
        null && _f !== void 0
        ? _f
        : this.close;
    ...
    this.direction = (0, Utils_2.getParticleDirectionAngle)(
    ...
    this.position = this.calcPosition(
      container,
      position,
      (0, Utils_2.clamp)(zIndexValue, 0, container.zLayers)
    );
      ...
      this.spin = {
        ...
        acceleration:
          (_j = this.retina.spinAcceleration) !== null && _j !== void 0
            ? _j
            : (0, Utils_2.getRangeValue)(this.options.move.spin.acceleration),
      };
    }
  ...
  getFillColor() {
    ...
    const color =
      (_a = this.bubble.color) !== null && _a !== void 0
        ? _a
        : (0, Utils_2.getHslFromAnimation)(this.color);
    if (color && this.roll && (this.backColor || this.roll.alter)) {
      const rolled =
        Math.floor(
          ((_c =
            (_b = this.roll) === null || _b === void 0 ? void 0 : _b.angle) !==
            null && _c !== void 0
            ? _c
            : 0) /
            (Math.PI / 2)
  ...
  getStrokeColor() {
    ...
    return (_b =
      (_a = this.bubble.color) !== null && _a !== void 0
        ? _a
        : (0, Utils_2.getHslFromAnimation)(this.strokeColor)) !== null &&
      _b !== void 0
      ? _b
      : this.getFillColor();
  }
  ...
  calcPosition(container, position, zIndex, tryCount = 0) {
    ...
    const pos = Utils_1.Vector3d.create(
      (_a = position === null || position === void 0 ? void 0 : position.x) !==
        null && _a !== void 0
        ? _a
        : Math.random() * canvasSize.width,
      (_b = position === null || position === void 0 ? void 0 : position.y) !==
        null && _b !== void 0
        ? _b
    ...
    fixHorizontal(
      (_d = outModes.right) !== null && _d !== void 0 ? _d : outModes.default
    );
    fixVertical(
      (_e = outModes.top) !== null && _e !== void 0 ? _e : outModes.default
    );
    fixVertical(
      (_f = outModes.bottom) !== null && _f !== void 0 ? _f : outModes.default
    );
  ...
  checkOverlap(pos, tryCount = 0) {
    ...
    for (const particle of this.container.particles.array) {
      if (
        (0, Utils_2.getDistance)(pos, particle.position) <
  ...
  calculateVelocity() {
    ...
    if (!moveOptions.straight) {
      res.angle += (0, Utils_2.randomInRange)(
        (0, Utils_2.setRangeValue)(range.left, range.right)
      );
    }
  ...
  loadShapeData(shapeOptions, reduceDuplicates) {
    ...
    if (shapeData) {
      return (0, Utils_2.deepExtend)(
        {},
        shapeData instanceof Array
          ? (0, Utils_2.itemFromArray)(shapeData, this.id, reduceDuplicates)
          : shapeData
      );
    }
  }
  loadLife() {
    ...
    const life = {
      delay: container.retina.reduceFactor
        ? (((0, Utils_2.getRangeValue)(lifeOptions.delay.value) *
      ...
      duration: container.retina.reduceFactor
        ? (((0, Utils_2.getRangeValue)(lifeOptions.duration.value) *
