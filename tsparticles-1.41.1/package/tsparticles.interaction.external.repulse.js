  ...
  return (function () {
    ...
    __webpack_require__.d(__webpack_exports__, {
      loadExternalRepulseInteraction: function () {
        return loadExternalRepulseInteraction;
      },
    });
    ...
    class Repulser extends ExternalInteractorBase {
      ...
      isEnabled() {
        ...
        return (
          Utils_isInArray("repulse", hoverMode) ||
          Utils_isInArray("repulse", clickMode) ||
          divRepulse
        );
      }
      reset() {}
      async interact() {
        ...
        if (
          ...
          this.hoverRepulse();
        } else if (clickEnabled && Utils_isInArray("repulse", clickMode)) {
          this.clickRepulse();
        } else {
      ...
      hoverRepulse() {
        ...
        this.processRepulse(
          mousePos,
          repulseRadius,
          new Circle_Circle(mousePos.x, mousePos.y, repulseRadius)
        );
      }
      processRepulse(position, repulseRadius, area, divRepulse) {
        ...
        for (const particle of query) {
          const {
              ...
              dy: dy,
              distance: distance,
            } = NumberUtils_getDistances(particle.position, position),
            velocity =
              ((_a =
        ...
        if (container.repulse.clicking) {
          ...
          for (const particle of query) {
            const {
                ...
                dy: dy,
                distance: distance,
              } = NumberUtils_getDistances(mouseClickPos, particle.position),
              d = distance ** 2,
              velocity =
            ...
            if (d <= repulseRadius) {
              ...
              const vect = Vector_Vector.create(dx, dy);
              vect.length = force;
