...
class EmitterInstance {
  ...
  play() {
    ...
    if (
      ...
      (__classPrivateFieldGet(this, _EmitterInstance_firstSpawn, "f") ||
  ...
  update(delta) {
    ...
    if (
      !__classPrivateFieldGet(this, _EmitterInstance_startParticlesAdded, "f")
    ) {
      __classPrivateFieldSet(
        this,
        _EmitterInstance_startParticlesAdded,
  ...
  prepareToDie() {
    ...
    const duration =
      (_a = this.options.life) === null || _a === void 0 ? void 0 : _a.duration;
    if (
      this.container.retina.reduceFactor &&
  ...
  emitParticles(quantity) {
    ...
    for (let i = 0; i < quantity; i++) {
      const particlesOptions = (0, Utils_1.deepExtend)(
        {},
