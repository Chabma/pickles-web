...
import type {
  IAnimatableGradientColor,
  IGradientColorOpacityAnimation,
} from "../Interfaces/IOptionsGradient";
...
export declare class AnimatableGradient
  implements IAnimatableGradient, IOptionLoader<IAnimatableGradient>
{
  angle: GradientAngle;
...
export declare class GradientAngle
  implements
    IGradientAngle,
    IAnimatable<IAnimation>,
    IOptionLoader<IGradientAngle & IAnimatable<IAnimation>>
{
...
export declare class GradientColorOpacity
  implements
    ...
    >
{
  ...
  constructor();
  load(
    data?: RecursivePartial<IGradientColorOpacity & IAnimatable<IAnimation>>
  ): void;
}
export declare class AnimatableGradientColor
  implements IAnimatableGradientColor, IOptionLoader<IAnimatableGradientColor>
{
  stop: number;
...
export declare class GradientAngleAnimation
  implements IAnimation, IOptionLoader<IAnimation>
{
  count: number;
  enable: boolean;
  speed: number;
...
export declare class GradientColorOpacityAnimation
  implements
    IGradientColorOpacityAnimation,
    IOptionLoader<IGradientColorOpacityAnimation>
{
  count: number;
  enable: boolean;
  speed: number;
