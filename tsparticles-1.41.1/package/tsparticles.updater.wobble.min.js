      ...
      init(e) {
        ...
        o.enable
          ...
          (e.retina.wobbleDistance =
            t(o.distance) * this.container.retina.pixelRatio);
      }
      isEnabled(e) {
      ...
      update(e, o) {
        this.isEnabled(e) &&
          (function (e, o) {
            ...
            const t = e.wobble.speed * o.factor,
              a =
              ...
              i = 2 * Math.PI;
            (e.wobble.angle += t),
              e.wobble.angle > i && (e.wobble.angle -= i),
              (e.position.x += a * Math.cos(e.wobble.angle)),
              (e.position.y += a * Math.abs(Math.sin(e.wobble.angle)));
          })(e, o);
      }
    }
    async function u(e) {
      await e.addParticleUpdater("wobble", (e) => new r(e));
    }
    return o;
  })();
});
