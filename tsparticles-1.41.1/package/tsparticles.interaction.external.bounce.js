  ...
  return (function () {
    ...
    function circleBounceDataFromParticle(p) {
      return {
        ...
        mass: p.getMass(),
        velocity: p.velocity,
        factor: Vector_Vector.create(
          NumberUtils_getValue(p.options.bounce.horizontal),
          NumberUtils_getValue(p.options.bounce.vertical)
        ),
      };
    }
    ...
    function rectBounce(particle, divBounds) {
      ...
      const resH = rectSideBounce(
        ...
        particle.velocity.x,
        NumberUtils_getValue(particle.options.bounce.horizontal)
      );
      if (resH.bounced) {
      ...
      const resV = rectSideBounce(
        ...
        particle.velocity.y,
        NumberUtils_getValue(particle.options.bounce.vertical)
      );
      if (resV.bounced) {
    ...
    class Bouncer extends ExternalInteractorBase {
      ...
      isEnabled() {
        ...
        return (
          (mouse.position &&
            ...
            Utils_isInArray("bounce", events.onHover.mode)) ||
      ...
      async interact() {
        ...
        if (
          mouseMoveStatus &&
          hoverEnabled &&
          Utils_isInArray("bounce", hoverMode)
        ) {
      ...
      processMouseBounce() {
        ...
        if (mousePos) {
          this.processBounce(
            mousePos,
            radius,
            new Circle_Circle(mousePos.x, mousePos.y, radius + tolerance)
          );
        }
      }
      singleSelectorBounce(selector, div) {
        ...
        query.forEach((item) => {
          ...
          const area =
            div.type === "circle"
              ? new Circle_Circle(pos.x, pos.y, radius + tolerance)
