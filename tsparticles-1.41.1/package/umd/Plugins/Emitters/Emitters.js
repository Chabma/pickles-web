...
(function (factory) {
  ...
  class Emitters {
      ...
      if (mode === "emitter") {
        ...
        const emittersOptions =
          emitterModeOptions !== null && emitterModeOptions !== void 0
            ...
            ? (0, Utils_1.itemFromArray)(emitterOptions)
            : emitterOptions;
        const ePosition = container.interactivity.mouse.clickPosition;
        this.addEmitter(
          (0, Utils_1.deepExtend)({}, emittersOptions),
          ePosition
        );
      }
    }
    ...
    addEmitter(options, position) {
      ...
      const emitter = new EmitterInstance_1.EmitterInstance(
        __classPrivateFieldGet(this, _Emitters_engine, "f"),
        this,
        this.container,
        emitterOptions,
        position
