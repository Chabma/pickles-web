(function (factory) {
  ...
  class Repulser extends Core_1.ExternalInteractorBase {
    ...
    isEnabled() {
      ...
      return (
        (0, Utils_1.isInArray)("repulse", hoverMode) ||
        (0, Utils_1.isInArray)("repulse", clickMode) ||
        divRepulse
      );
    }
    reset() {}
    async interact() {
      ...
      if (
        ...
        (0, Utils_1.divModeExecute)("repulse", divs, (selector, div) =>
    ...
    hoverRepulse() {
      ...
      this.processRepulse(
        mousePos,
        repulseRadius,
        new Core_1.Circle(mousePos.x, mousePos.y, repulseRadius)
      );
    }
    processRepulse(position, repulseRadius, area, divRepulse) {
      ...
      for (const particle of query) {
        const { dx, dy, distance } = (0, Utils_1.getDistances)(
          ...
          repulseFactor = (0, Utils_1.clamp)(
            (0, Utils_1.calcEasing)(
              1 - distance / repulseRadius,
              repulseOptions.easing
            ) * velocity,
            0,
            repulseOptions.maxSpeed
          ),
          normVec = Core_1.Vector.create(
