  ...
  class Bouncer extends Core_1.ExternalInteractorBase {
    ...
    isEnabled() {
      ...
      return (
        (mouse.position &&
          ...
          (0, Utils_1.isInArray)("bounce", events.onHover.mode)) ||
    ...
    async interact() {
      ...
      if (
        mouseMoveStatus &&
        hoverEnabled &&
        (0, Utils_1.isInArray)("bounce", hoverMode)
      ) {
        this.processMouseBounce();
      } else {
        (0, Utils_1.divModeExecute)("bounce", divs, (selector, div) =>
    ...
    processMouseBounce() {
      ...
      if (mousePos) {
        this.processBounce(
          mousePos,
          radius,
          new Core_1.Circle(mousePos.x, mousePos.y, radius + tolerance)
        );
      }
    }
    ...
    processBounce(position, radius, area) {
      ...
      for (const particle of query) {
        if (area instanceof Core_1.Circle) {
          (0, Utils_1.circleBounce)(
            (0, Utils_1.circleBounceDataFromParticle)(particle),
            {
              position,
              radius,
          ...
          (0, Utils_1.rectBounce)(
            particle,
            (0, Utils_1.calculateBounds)(position, radius)
          );
        }
      }
    }
