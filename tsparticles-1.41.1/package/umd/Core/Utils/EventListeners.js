(function (factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    ...
    define(["require", "exports", "../../Utils", "./Constants"], factory);
  }
  ...
  class EventListeners {
    ...
    manageListeners(add) {
      ...
      if (
        ...
        manageListener(
          interactivityEl,
          Constants_1.Constants.mouseMoveEvent,
          this.mouseMoveHandler,
          add
        );
        manageListener(
          interactivityEl,
          Constants_1.Constants.touchStartEvent,
          this.touchStartHandler,
          add
        );
        manageListener(
          interactivityEl,
          Constants_1.Constants.touchMoveEvent,
        ...
        if (!options.interactivity.events.onClick.enable) {
          manageListener(
            interactivityEl,
            Constants_1.Constants.touchEndEvent,
          ...
          manageListener(
            interactivityEl,
            Constants_1.Constants.mouseUpEvent,
            this.mouseUpHandler,
            add
          );
          manageListener(
            interactivityEl,
            Constants_1.Constants.mouseDownEvent,
        ...
        manageListener(
          interactivityEl,
          Constants_1.Constants.touchCancelEvent,
      ...
      if (options.interactivity.events.resize) {
        if (typeof ResizeObserver !== "undefined") {
          ...
          manageListener(
            window,
            Constants_1.Constants.resizeEvent,
            this.resizeHandler,
            add
          );
        }
      ...
      if (document) {
        manageListener(
          document,
          Constants_1.Constants.visibilityChangeEvent,
      ...
      switch (mode) {
        case "push": {
          if (pushNb > 0) {
            ...
            const group = (0, Utils_1.itemFromArray)([
              undefined,
              ...pushOptions.groups,
            ]);
            const groupOptions =
