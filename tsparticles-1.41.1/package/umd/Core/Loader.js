...
(function (factory) {
  ...
  class Loader {
    ...
    async loadOptions(params) {
      ...
      const tagId =
        (_a = params.tagId) !== null && _a !== void 0
          ? _a
          : `tsparticles${Math.floor(Math.random() * 10000)}`;
      ...
      const currentOptions =
        options instanceof Array
          ? (0, Utils_2.itemFromArray)(options, index)
          : options;
      const dom = this.dom();
      ...
      const newItem = new Container_1.Container(
        __classPrivateFieldGet(this, _Loader_engine, "f"),
        tagId,
        currentOptions
      );
      if (oldIndex >= 0) {
    ...
    async loadRemoteOptions(params) {
      ...
      const url =
        jsonUrl instanceof Array
          ? (0, Utils_2.itemFromArray)(jsonUrl, index)
          : jsonUrl;
      if (!url) {
        return;
      }
